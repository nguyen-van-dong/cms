            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('cms::category.edit.index') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ __('cms::category.edit.page_title') }}</h4>
            </div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <form role="form" action="{{ route('cms.admin.category.update', $item->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-8">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">{{ __('cms::category.edit.page_title') }}</h3>
                        @translatableAlert
                    </div>
                    <div class="card-body">
