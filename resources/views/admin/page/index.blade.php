            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-right">
                  ...
                  <a href="{{ route('cms.admin.page.create', ['id' => $item->id, 'parent_id' => $item->id]) }}" class="btn btn-primary-soft btn-sm mr-1" style="background-color: rgb(211 250 255); color: #0fac04; width: 32px;border-color: rgb(167 255 247); border: 1px solid">
                    <i class="fas fa-plus" style="font-size: 15px; margin-left: -5px; margin-top: 5px"></i>
                  </a>
                  @endadmincan

                  @admincan('cms.admin.page.edit')
                  <a href="{{ route('cms.admin.page.move-up', $item->id) }}" class="btn btn-info-soft btn-sm mr-1" style="background-color: rgb(211 250 255); color: #0fac04; width: 32px;border-color: rgb(167 255 247); border: 1px solid">
                    <i class="fas fa-chevron-up" style="font-size: 15px; margin-left: -5px; margin-top: 5px"></i>
                  </a>
                  @endadmincan

                  @admincan('cms.admin.page.edit')
                  <a href="{{ route('cms.admin.page.move-down', $item->id) }}" class="btn btn-info-soft btn-sm mr-1" style="background-color: rgb(211 250 255); color: #0fac04; width: 32px;border-color: rgb(167 255 247); border: 1px solid">
                  ...
                  <x-button-delete-v1 url="{{ route('cms.admin.page.destroy', $item->id) }}" />
                  @endadmincan
                </td>
